...
with open('C:/Users/Abhisek/Downloads/Project/DJIA indices data.csv', 'r') as csvfile:
...
for year in years:
    for month in months:
        file_str = 'C:/Users/Abhisek/Downloads/Project' + str(year) + '-' + '{:02}'.format(month) + '.json'
